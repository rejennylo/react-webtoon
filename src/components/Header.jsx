...
export const Header = () => {
  ...
  return (
    <header>
      <div className="flex mx-auto items-center max-w-screen-xl relative">
        <h1>
          <a href="#"></a>
        </h1>
        <ul className="flex items-center my-8 absolute right-0">
        ...
        <div className="hidden flex items-center justify-between my-8 absolute right-0 border-solid border border-gray-300 rounded-full ml-3 h-9 w-[330px] px-3 bg-white">
