...
export const CardLg = ({
  ...
  return (
    <li className={`card-lg list-none inline-block`}>
      <a href="#" className="relative max-h-[210px] max-w-[435px]">
        <div className="absolute top-0 left-0 h-full w-full">
          <div className="p-[2.5%]">
            <h3 className="text-xl font-semibold">{title}</h3>
            <p className="whitespace-normal text-xs text-white w-3/5 pt-2">
              {synopsis}
            </p>
          ...
          >
            <div className="p-[2.5%]">
              ...
              <div className="relative py-[2%] before:absolute before:top-[45%] before:border-t before:border-solid before:w-[9%]">
                <p className="text-sm text-white ">{author}</p>
                <p className="whitespace-normal text-xs text-white pt-[10%]">
                  {synopsis}
                </p>
              </div>
            </div>
