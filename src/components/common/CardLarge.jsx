...
export const CardLarge = ({
  ...
  return (
    <li
      className={
        styles + "card-l inline-block list-none h-[210px] w-[435px] relative"
      }
    >
      <a href="#" className="h-full w-full">
        <div className="h-[210px] w-[435px] relative z-10">
          <div className="card_front">
            <div className="info p-3">
              <h3 className="text-xl font-semibold">{title}</h3>
              <p className="text-xs text-white whitespace-normal">{synopsis}</p>
